...
def get_representation(
    ...
    folder = '../privateDemographics/data/%s_%s_representation' % (dataset_name, model)
...
def pred_groups(
    ...
    if dataset_name == 'synthetic':
        train_path = '../privateDemographics/data/synthetic_moon_(100,30,300)_circles_(200,30,300)_factor_0.5_blobs_(1000,300,300)_noise_(0.1,0.1,0.1)_seed_123/train.csv'
        val_path = '../privateDemographics/data/synthetic_moon_(100,30,300)_circles_(200,30,300)_factor_0.5_blobs_(1000,300,300)_noise_(0.1,0.1,0.1)_seed_123/val.csv'
        test_path = '../privateDemographics/data/synthetic_moon_(100,30,300)_circles_(200,30,300)_factor_0.5_blobs_(1000,300,300)_noise_(0.1,0.1,0.1)_seed_123/test.csv'
    elif dataset_name in ['waterbirds', 'civilcomments', 'multinli']:
        train_path = '../balanceGroups/data/%s' % dataset_name
        val_path = None,
        test_path = None,
    ...
    if method == 'grass':
        ...
        if clustering_path_use: 
            if dataset_name == 'civilcomments':
                clustering_path = [
                    '../privateDemographics/results/civilcomments/clustering_y_0_min_samples_50_eps_0.35.npy',
                    '../privateDemographics/results/civilcomments/clustering_y_1_min_samples_100_eps_0.50.npy'
                ]
            elif dataset_name == 'waterbirds':
                clustering_path = None
            elif dataset_name == 'synthetic':
                clustering_path = [
                    '../privateDemographics/results/synthetic/clustering_y_0_min_samples_20_eps_0.40.npy',
                    '../privateDemographics/results/synthetic/clustering_y_1_min_samples_60_eps_0.45.npy'
                ]
            elif dataset_name == 'multinli':
                # clustering_path = [
                #     '../privateDemographics/results/multinli/clustering_y_0_min_samples_20_eps_0.40.npy',
                #     '../privateDemographics/results/multinli/clustering_y_1_min_samples_60_eps_0.45.npy'
                # ]
                clustering_path = None
